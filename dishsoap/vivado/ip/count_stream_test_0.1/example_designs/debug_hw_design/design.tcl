...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of count_stream_test_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins count_stream_test_0/S_AXI_registers]
	connect_bd_net [get_bd_pins count_stream_test_0/s_axi_registers_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins count_stream_test_0/s_axi_registers_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock & reset of count_stream_test_0 streaming interfaces..
	connect_bd_net [get_bd_pins count_stream_test_0/m_axis_output_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins count_stream_test_0/m_axis_output_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to count_stream_test_v0_1_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/count_stream_test_v0_1_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_count_stream_test_0_S_AXI_registers_* ]]
	puts $fp "set s_axi_registers_addr ${offset}"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/count_stream_test_v0_1_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "count_stream_test_v0_1_hw_${i}"
