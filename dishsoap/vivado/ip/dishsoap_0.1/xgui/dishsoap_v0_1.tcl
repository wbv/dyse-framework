...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_REGS_AXI_DATA_WIDTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_REGS_AXI_ADDR_WIDTH" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "C_SIM_STATE_AXIS_TDATA_WIDTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_SIM_STATE_AXIS_START_COUNT" -parent ${Page_0}
